...
class AulaHorarioModel extends Model
{
    ...
    protected $allowedFields    = ['aula_id', 'tempo_de_aula_id', 'versao_id', 'fixa', 'bypass', 'destaque'];
    ...
    {
        $this->db->simpleQuery("UPDATE aula_horario SET destaque = 1 WHERE id = '$aula_horario_id'");
    }

    public function desDestacarAulaHorario($aula_horario_id)
    {
        $this->db->simpleQuery("UPDATE aula_horario SET destaque = 0 WHERE id = '$aula_horario_id'");
    }
}
